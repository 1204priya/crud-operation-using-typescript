...
export const getStudentData  =async (req:any,res:any)=>{
    try{
        const findStudentByQuery : any|null|undefined={};
...
export const updateStudents=async(req:any,res:any)=>{
    try{
        const Student:any|null|undefined = await student.findOne({id:req.params.id});
        ...
        const response :any|null|undefined = await Student.save();
...
export const deleteData=async(req:any,res:any)=>{
    try{
        const deleteStudent:any|null|undefined =await student.findOne({id:req.params.id});
